...
2. Модель хорошо классифицирует (см. ноутбук с обучением, раздел "Тестирование") - 36% правильных на FT против 0% на изначальной модели.
3. Модель посредственно справляется с расстановкой границ проблемных областей. Тестирование по метрике iou (см. ноутбук с обучением, раздел "Тестирование") показало прирост в качестве модели после дообучения (0.054 балла на FT против 0.006 изначальных) - тем не менее, этого недостаточно. 
